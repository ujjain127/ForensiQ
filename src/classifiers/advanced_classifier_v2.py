"""
ForensiQ Advanced Evidence Classification Engine V2
=================================================
Advanced ensemble with custom balancing and optimization
Target accuracy: 85%+
"""
...
class AdvancedEvidenceClassifierV2:
    """
    Advanced evidence classification engine V2
    Custom balancing and optimization for 85%+ accuracy
    """
    ...
    def create_advanced_confusion_matrix(self, y_test, y_pred):
        ...
        matrix_path = reports_dir / 'advanced_confusion_matrix.png'
        plt.tight_layout()
        plt.savefig(matrix_path, dpi=300, bbox_inches='tight')
        print(f"   💾 Advanced confusion matrix saved to: {matrix_path}")
    ...
    def create_advanced_metrics_visualization(self):
        ...
        metrics_path = reports_dir / 'advanced_metrics_dashboard.png'
        plt.savefig(metrics_path, dpi=300, bbox_inches='tight')
        print(f"   💾 Advanced metrics dashboard saved to: {metrics_path}")
        
        plt.close()
    
    def save_advanced_model(self, model_path='models/classifier/advanced_evidence_classifier.pkl'):
        ...
        joblib.dump(self.tfidf_vectorizer, model_dir / 'advanced_tfidf_vectorizer.pkl')
        joblib.dump(self.feature_selector, model_dir / 'advanced_feature_selector.pkl')
        joblib.dump(self.scaler, model_dir / 'advanced_feature_scaler.pkl')
...
def main():
    """Main function"""
    print("🚀 ForensiQ Advanced Evidence Classification Engine V2")
    print("=" * 70)
    ...
    classifier = AdvancedEvidenceClassifierV2()
    ...
    print("-" * 40)
    classifier.save_advanced_model()
    ...
    report = {
        "model_info": {
            "model_name": "Advanced Multi-Algorithm Ensemble V2",
    ...
    report_path = Path('reports/advanced_model_evaluation_report_v2.json')
    ...
    # Final summary
    print(f"\n🎉 ADVANCED CLASSIFICATION ENGINE V2 COMPLETE!")
    print("=" * 70)
    ...
    if final_accuracy >= 0.85:
        ...
        print("🎉 EXCELLENT PROGRESS! (80%+) Very close to target!")
    else:
